...
import { SiReact, SiNextdotjs, SiTypescript, SiTailwindcss, SiNodedotjs, SiMongodb, SiPostgresql, SiPrisma } from 'react-icons/si'
    ...
    <>
      <section className="relative overflow-hidden min-h-screen flex flex-col bg-black -mt-24 pt-24" style={{ zIndex: 10, isolation: 'isolate' }}>
        <div className="absolute inset-0 z-0 h-full w-full">
          <MuxPlayer
            playbackId="tLkHO1qZoaaQOUeVWo8hEBeGQfySP02EPS02BmnNFyXys"
            autoPlay="muted"
            loop
            muted
            playsInline
            ...
            style={{ 
              ...
              '--controls': 'none',
              filter: 'sepia(1) hue-rotate(-15deg) saturate(5)' 
            } as any}
          />
        </div>

        <div className="container mx-auto px-4 py-24 sm:py-32 relative z-10 flex-1 flex flex-col pointer-events-none">
          <div className="max-w-4xl text-left flex-1 flex flex-col justify-center items-start pointer-events-auto pt-16 md:pt-0">
            {/* Badge */}
            <motion.div
            ...
            <motion.div
              ...
              className="mb-8"
            >
              <h1 id="main-title" className="text-4xl font-normal tracking-tight text-white sm:text-6xl lg:text-7xl leading-[1.1]">
                Build Your <span className="font-bold">Online Presence</span>&<br />Grow Your <span className="font-bold">Business Effortlessly</span>
              </h1>
            </motion.div>
            ...
            >
              We create beautiful, responsive, and SEO-friendly websites that help entrepreneurs and small businesses
              launch and grow their online presence. Let's build something amazing together.
            </motion.p>
          </div>
          ...
          <motion.div
            ...
            className="flex flex-col items-center gap-4 pointer-events-auto w-full mt-auto pb-12"
          >
            <svg
              width="100"
              height="50"
            ...
            <Link href="/signup">
              <div className="group cursor-pointer border border-border bg-card gap-2 h-[60px] flex items-center p-[10px] rounded-full">
                <div className="border border-border bg-primary h-[40px] rounded-full flex items-center justify-center text-primary-foreground">
                  <p className="font-normal tracking-tight mr-3 ml-3 flex items-center gap-2 justify-center text-base">
      ...
      {/* Social Proof Section - Placed AFTER Hero */}
      <div className="w-full bg-black border-y border-border/20 py-10 relative z-20">
        <motion.div
        ...
        >
          <div className="text-center">
            <p className="text-sm text-muted-foreground mb-8 uppercase tracking-widest font-normal">Powered By Our Modern Tech Stack</p>
