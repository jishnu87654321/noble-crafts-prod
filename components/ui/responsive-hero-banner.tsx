...
const ResponsiveHeroBanner: React.FC<ResponsiveHeroBannerProps> = ({
    logoUrl = "https://images.unsplash.com/photo-1614728263952-84ea206f99b6?q=80&w=200&auto=format&fit=crop",
    ...
    return (
        <section className="w-full isolate min-h-screen overflow-hidden relative flex flex-col">
            ...
            />
            <div className="pointer-events-none absolute inset-0 ring-1 ring-black/30 bg-black/40 -z-10" />
            ...
            <header className="z-10 xl:top-4 relative">
                <div className="mx-6">
                    <div className="flex items-center justify-between pt-4">
                        <a
                            href="/"
                            className="inline-flex items-center justify-center font-bold text-white text-2xl tracking-tighter"
                        >
                           NOBLE<span className="text-[#e78a53]">CRAFTS</span>
                        </a>
                ...
                {showContent ? (
                  <div className="max-w-7xl mx-auto px-6 py-16">
                      <div className="mx-auto max-w-3xl text-center">
                          <div className="mb-6 inline-flex items-center gap-3 rounded-full bg-white/10 px-2.5 py-2 ring-1 ring-white/15 backdrop-blur animate-[fadeSlideIn_0.8s_ease-out_forwards]">
                          ...
                          <h1 className="sm:text-5xl md:text-6xl lg:text-7xl leading-tight text-4xl text-white tracking-tight font-instrument-serif font-normal animate-[fadeSlideIn_1s_ease-out_forwards]">
                              {title}
                              <br className="hidden sm:block" />
                              {titleLine2}
                          </h1>

                          <p className="sm:text-lg text-base text-white/80 max-w-2xl mt-6 mx-auto animate-[fadeSlideIn_1.2s_ease-out_forwards]">
                              {description}
                          </p>

                          <div className="flex flex-col sm:flex-row sm:gap-4 mt-10 gap-3 items-center justify-center animate-[fadeSlideIn_1.4s_ease-out_forwards]">
                              <a
                      ...
                      <div className="mx-auto mt-20 max-w-5xl">
                          <p className="text-sm text-white/70 text-center animate-[fadeSlideIn_1.6s_ease-out_forwards]">
                              {partnersTitle}
                          </p>
                          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 text-white/70 mt-6 items-center justify-items-center gap-4 animate-[fadeSlideIn_1.8s_ease-out_forwards]">
